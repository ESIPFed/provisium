...
func QueryServiceOpenSearch(w http.ResponseWriter, r *http.Request) {
	w.Write([]byte("Whoa there....  you have reached the edge of our ever expanding universe"))
}

func QueryServiceSwagger(w http.ResponseWriter, r *http.Request) {
	w.Write([]byte("Whoa there....  you have reached the edge of our ever expanding universe"))
}

func QueryServiceSchema(w http.ResponseWriter, r *http.Request) {
	w.Write([]byte("Whoa there....  you have reached the edge of our ever expanding universe"))
}
